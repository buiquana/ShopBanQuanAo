...
const ProductsSaleDetailsScreen = ({ route, navigation }) => {
  ...
  useEffect(() => {
    const fetchProductDetails = async () => {
      try {
        // const response = await fetch(`http://192.168.0.105:3000/saleproducts/${productId}`);
              ...
              <FlatList
                ...
                renderItem={({ item,index }) => (
                  ...
                  style={[
                    ...
                    selectedColorIndex === index && selectedColor && styles.selectedColorImageContainer, 
                  ]}>
                    <Image source={{ uri: item.image }} style={[styles.colorImage, selectedColorIndex === index && selectedColor && styles.selectedColorImage]} />
                  </TouchableOpacity>
                )}
              />
            )}
...
export default ProductsSaleDetailsScreen;
